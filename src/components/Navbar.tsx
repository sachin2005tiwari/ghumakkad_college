    ...
    <header className="flex flex-col lg:flex-row justify-between items-center px-4 py-3 lg:px-8 bg-brand-light shadow-md">
      ...
      <div className="flex justify-between items-center w-full lg:w-auto mb-2 lg:mb-0">
        ...
        <div className="flex items-center">
            ...
            <p className="text-brand-secondary text-2xl lg:text-3xl font-bold">Ghumakkad</p>
        </div>
      ...
      <div className="user-signup hidden lg:block">
        <Link 
          to="/login" 
          className="text-white bg-brand-secondary py-2.5 px-4 no-underline border border-white rounded-[40px] transition duration-300 hover:bg-brand-primary"
        >
          Login
        </Link>
      </div>
